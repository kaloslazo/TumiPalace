    ...
    <div class="bg-transparent max-w-3xl mx-auto flex flex-col items-center justify-center mt-10">
        ...
        <div class="bg-brown-850 max-w-2xl w-full flex flex-col justify-center items-center rounded-md py-12">
            <div class="flex flex-row justify-center mb-12 items-center">
                <img class="h-11 w-auto mr-3" src="../assets/img/tumiLogo.png" alt="">
            ...
            <form @submit.prevent="login" class="flex flex-col justify-center- items-start gap-5 w-full max-w-sm z-10">
                <div class="flex flex-col gap-2 w-full">
                    ...
                    <input class="border-2 text-white border-brown-900 bg-brown-900 py-3 px-4 focus:border-brown-950 focus:outline-0" type="text" v-model="username" placeholder="Nickname" required />
                </div>
                <div class="flex flex-col gap-2 w-full">
                    <label for="nickname" class="text-white font-medium">Password</label>
                    <input class="border-2 text-white border-brown-900 bg-brown-900 py-3 px-4 focus:border-brown-950 focus:outline-0" type="password" v-model="password" placeholder="Password" required />
                ...
                <button class="rounded-sm bg-yellow-600 w-full mt-5 py-2" type="submit">Login</button>
            </form>
